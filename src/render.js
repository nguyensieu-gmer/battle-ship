class Render {
  ...
  showShipPlacement(player, shipList) {
    ...
    axisArea.appendChild(x_axis);
    const y_axis = document.createElement('button');
    y_axis.textContent = 'y-axis';
    y_axis.id = 'y-axis';
    y_axis.dataset.axis = false;
    axisArea.appendChild(y_axis);
    mainBoard.appendChild(axisArea);
